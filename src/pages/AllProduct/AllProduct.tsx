    ...
    return (
      <div className={`${isList ? 'flex' : ''} bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 ${isList ? 'hover:translate-x-1' : 'transform hover:scale-105'}`}>
        ...
        <div className={`${isList ? 'flex-1' : ''} p-4`}>
          ...
          <div className={`flex items-center ${isList ? 'justify-end gap-4' : 'justify-between'}`}>
            {!isList && (
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            ...
            <div className="flex items-center gap-2 ml-auto">
              <button
                ...
                className={`flex items-center gap-1 px-3 py-2 rounded-lg border ${viewType === 'grid' ? 'bg-[#F5F1E8] text-[#7C5228] border-[#E8E0D0]' : 'bg-white text-gray-600 border-gray-200'} hover:bg-[#F5F1E8] hover:text-[#7C5228]`}
                title="Grid view"
              >
              ...
              <button
                ...
                className={`flex items-center gap-1 px-3 py-2 rounded-lg border ${viewType === 'list' ? 'bg-[#F5F1E8] text-[#7C5228] border-[#E8E0D0]' : 'bg-white text-gray-600 border-gray-200'} hover:bg-[#F5F1E8] hover:text-[#7C5228]`}
                title="List view"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-2xl font-semibold text-gray-600 mb-2">No cakes found</h3>
